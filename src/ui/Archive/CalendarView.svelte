  ...
  <div class=" calendar">
    <div class="calendar-header">
        <div class="header-year">2020</div>
        <div class="header-day">Thursday, Jan 23</div>
        </div>
        <div class="calendar-content">
            <div class="calendar-toolbar">
                <span class="prev-month"><span class="default-icon-chevron-left"></span></span>
                <span class="curr-month">January</span>
            ...
            <div class="week-days">
                ...
                <span class="day">Su</span><span class="day">Mo</span><span class="day">Tu</span><span class="day">We</span><span class="day">Th</span><span class="day">Fr</span>
                <span class="day">Sa</span>
            </div>
            <div class="days">
                <div class="days-row">
                    <div class="day outside">29</div>
                    <div class="day outside">30</div>
                    <div class="day outside">31</div>
                    <div class="day">1</div><div class="day">2</div><div class="day">3</div><div class="day">4</div></div>
                <div class="days-row">
                    <div class="day">5</div>
                    <div class="day">6</div>
                    <div class="day">7</div>
                    <div class="day">8</div>
                    <div class="day">9</div>
                    <div class="day">10</div><div class="day">11</div></div>
                <div class="days-row">
                    <div class="day">12</div><div class="day">13</div><div class="day">14</div><div class="day">15</div><div class="day">16</div><div class="day">17</div>
                    <div class="day">18</div></div>
                <div class="days-row">
                    <div class="day">19</div><div class="day">20</div><div class="day">21</div><div class="day">22</div>
                    <div class="day showed today">23</div><div class="day">24</div><div class="day">25</div></div>
                <div class="days-row">
                    ...
                    <div class="day outside">1</div></div></div></div>
